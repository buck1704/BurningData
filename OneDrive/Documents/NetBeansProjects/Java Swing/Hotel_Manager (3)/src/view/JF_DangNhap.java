    ...
    private void bt_DangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_DangNhapActionPerformed
        try (Connection conn = DriverManager.getConnection(Hotel_Manager.dbURL);
            ...
            if (rsNV.next()) {
                ...
                Hotel_Manager.sTenNhanVien = rsNV.getString("tennhanvien");
                Hotel_Manager.sMaChucVu = rsNV.getString("machucvu");
                Hotel_Manager.sGioiTinh = rsNV.getString("gioitinh");
                Hotel_Manager.sNgaySinh = rsNV.getString("ngaysinh");
                Hotel_Manager.sSDT = rsNV.getString("sdt");
                Hotel_Manager.sDiaChi = rsNV.getString("diachi");
                Hotel_Manager.sLuong =rsNV.getString("luongtheongay");
                JP_PhieuDangKy.laymanhanvien = Hotel_Manager.sMaNhanVien;
                JF_AboutMe.laymanhanvien= Hotel_Manager.sMaNhanVien;
                JF_AboutMe.laytennv= Hotel_Manager.sTenNhanVien;
                JF_AboutMe.laymacv = Hotel_Manager.sMaChucVu;
                JF_AboutMe.laygioitinh= Hotel_Manager.sGioiTinh;
                JF_AboutMe.layngaysinh=Hotel_Manager.sNgaySinh;
                JF_AboutMe.laysodienthoai=Hotel_Manager.sSDT;
                JF_AboutMe.laydiachi=Hotel_Manager.sDiaChi;
                JF_AboutMe.layluong=Hotel_Manager.sLuong;
                dispose();
