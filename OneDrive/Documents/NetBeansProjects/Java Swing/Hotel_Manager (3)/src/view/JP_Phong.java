...
public class JP_Phong extends javax.swing.JPanel {
    ...
    public Component getTableCellRendererComponent(Object value, int column) {
        Component c = getTableCellRendererComponent( value,column);
        c.setBackground(value == "Đầy" ? Color.LIGHT_GRAY : Color.WHITE);
        return c;
    }
