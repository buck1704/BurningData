...
public class Home extends javax.swing.JFrame {
    ...
    int xy, xx;
    private void pnlTopMouseDragged(java.awt.event.MouseEvent evt) {                                    
        int x = evt.getXOnScreen();
        int y = evt.getYOnScreen();
        this.setLocation(x - xx, y - xy);
    }                                   

    private void pnlTopMouseClicked(java.awt.event.MouseEvent evt) {                                    
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1322, 200));
        ...
        jLabel2.setPreferredSize(new java.awt.Dimension(294, 150));
        jPanel1.add(jLabel2, java.awt.BorderLayout.PAGE_START);

        jLabel1.setFont(new java.awt.Font("Century Gothic", 0, 36)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("We are happy for your return!");
